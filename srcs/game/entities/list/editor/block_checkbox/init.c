...
static t_result	init_block_checkbox_entity3(t_block_checkbox_entity *const self)
{
...
static void		init_block_checkbox_entity2(t_block_checkbox_entity *const self)
{
		...
		ft_frame_transform(ft_vec2f(0.5f, 0.5f),
			...
			ft_vec2f((float)self->super.super.normal_texture.size.x
				...
				(float)self->super.super.normal_texture.size.y
					/ (float)self->block->texture.size.y * 0.7),
			255));
	init_block_checkbox_entity2(self);
	return (init_block_checkbox_entity3(self));
}
