...
/*   Updated: 2020/01/22 18:52:52 by lbenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
				...
				const t_ghost_segment_component_entity_args *const args)
{
	...
	self->super.super.transform.position =
		args->start_vertex->super.super.transform.position;
	...
	self->b = self->a;
	self->vertex_ref = args->start_vertex;
